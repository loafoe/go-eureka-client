...
// NewInstanceInfoWithInstanceID returns an InstanceInfo with the instanceID set as well
func NewInstanceInfoWithInstanceID(hostName, app, ip, instanceID string, port int, ttl uint, isSsl bool) *InstanceInfo {
	instance := NewInstanceInfo(hostName, app, ip, port, ttl, isSsl)
